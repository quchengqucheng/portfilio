...
ShortestPathCalculator.prototype.populateDistances = function() {
	...
	for(var i=0; i<this.paths.length; i++) {
        console.log(this.paths[i].source.id,this.paths[i].target.id,this.idIndex[this.paths[i].source.id],this.idIndex[this.paths[i].target.id]);
